...
<style>
  ...
  .cereal-title-bar {
    ...
    border-bottom: 4px solid #801008;
  }
  .cereal-title-bar span { display: block; font-size: 11px; font-weight: normal; font-family: Arial, sans-serif; letter-spacing: 0.15em; color: #ffddcc; margin-top: 2px; }
  .cereal-body { padding: 14px 18px; }
  .cereal-nutrition { border: 2px solid #1a1a1a; margin-bottom: 14px; }
  .cereal-nutrition-title { background: #1a1a1a; color: #f5f0e8; font-size: 20px; font-weight: 900; padding: 4px 10px; font-family: Impact, 'Arial Black', sans-serif; letter-spacing: 0.02em; }
  ...
  .cereal-fortified { background: #fff8e0; border: 1px solid #c8a000; padding: 8px 12px; font-size: 10.5px; color: #444; line-height: 1.7; margin-bottom: 12px; text-align: center; }
...
<div class="cereal-wrap">
  ...
  <div class="cereal-body">
    <div class="cereal-nutrition">
      ...
      <div class="cereal-nutrient">
        <span class="cereal-nutrient-name">Founders</span>
    ...
    <div class="cereal-upc-row">
      <div class="cereal-upc-text">
        ...
        Felice & the Founders, proprietors<br>
