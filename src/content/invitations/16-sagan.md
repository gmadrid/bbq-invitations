---
windowTitle: "Billions"
style: "Billions..."
date: 2026-04-24
type: text
fonts: ["Spectral:ital,wght@0,400;0,700;1,400"]
accentColor: "#0a1a3a"
teaser: "Consider the rear garden."
thumbnail: "/thumbnails/16-sagan.png"
---

<style>
.inv-text-body, .inv-text-body p, .inv-text-body em, .inv-text-body strong { font-family: 'Spectral', Georgia, serif; }
.inv-text-body h1, .inv-text-body h2, .inv-text-body h3 { font-family: 'Spectral', Georgia, serif; font-weight: 700; font-style: normal; }
</style>
