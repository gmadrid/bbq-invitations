...
<style>
.inv-text-body { font-family: 'Source Serif 4', Georgia, serif; }
.inv-text-body h1, .inv-text-body h2, .inv-text-body h3 { font-family: 'DM Serif Display', Georgia, serif; font-weight: normal; font-style: normal; }
.inv-text-body strong { font-family: 'DM Serif Display', Georgia, serif; font-weight: normal; font-size: 1.05em; letter-spacing: 0.02em; }
</style>
