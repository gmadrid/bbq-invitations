---
windowTitle: "The Bear"
style: "The Bear"
date: 2026-04-29
type: text
fonts: ["Boogaloo"]
accentColor: "#8a5a00"
teaser: "Wocka wocka wocka! You have to come! Jeannine is going to be there!"
thumbnail: "/thumbnails/21-fozzie.png"
---

<style>
.inv-text-body, .inv-text-body p, .inv-text-body em, .inv-text-body strong { font-family: 'Boogaloo', cursive; }
.inv-text-body h1, .inv-text-body h2, .inv-text-body h3 { font-family: 'Boogaloo', cursive; font-weight: 700; font-style: normal; }
</style>
