...
thumbnail: "/thumbnails/13-hemingway.png"
---

<style>
.inv-text-body, .inv-text-body p, .inv-text-body em, .inv-text-body strong { font-family: 'Special Elite', 'Courier New', monospace; }
.inv-text-body h1, .inv-text-body h2, .inv-text-body h3 { font-family: 'Special Elite', 'Courier New', monospace; font-weight: normal; font-style: normal; }
</style>
